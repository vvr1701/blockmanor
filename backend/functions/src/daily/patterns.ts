 ...
 * lists "30 daily-board pattern templates" as a content-ops task; this is that
 * set of 30, hand-authored and kept beside the generator that consumes it. Moving it to `packages/content` later changes no
