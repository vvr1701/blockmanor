...
**Version:** 1.18 · **Date:** 2026-09-07 · **Status:** Approved for build
...
### 8.3 Client flow
Gate screen (countdown to next board, "one attempt", yesterday's percentile; the board is refused until its `activatesAt`, §8.2) → PLAY → gameplay with gold DAILY frame, attempt badge 1/1 → run ends (board death **or** sequence exhaustion, §8.2) → result: score count-up 900ms → percentile reveal → share card → "Continue to levels".
...
**Daily board:** `daily_piece_count 60 · daily_reroll_cap 5 · daily_streak_min_moves 3 · daily_push_hour 8 · streak_repair_price 89`
...
*End of PRD v1.18 — amendments require a changelog entry (§0).*
